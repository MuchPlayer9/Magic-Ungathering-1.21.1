...
public class LargeManaStick extends SwordItem {

    public LargeManaStick(Properties durability) {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        float manaToGrant = 50.0f;
        float damageAmount = 6.0f; // 3 Hearts
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.literal("Tier: ").withStyle(ChatFormatting.GRAY)
                .append(Component.literal("Large").withStyle(ChatFormatting.DARK_RED, ChatFormatting.BOLD)));
        tooltip.add(Component.literal("A heavy sacrifice for immense power.").withStyle(ChatFormatting.DARK_PURPLE, ChatFormatting.ITALIC));
